...
- (instancetype)initWithFont:(UIFont *)font textColor:(UIColor *)color linesNumber:(NSUInteger)linesNumber offset:(NSUInteger)offset;
...
// Init.
- (instancetype)initWithTitle:(NSString *)title subTitle:(NSString *)subTitle pictureName:(NSString *)pictureName duration:(NSTimeInterval)duration;
