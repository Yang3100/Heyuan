...
- (ICETutorialLabelStyle *)titleStyle {
    ...
    return [[ICETutorialLabelStyle alloc] initWithFont:self.titleFont textColor:self.titleColor linesNumber:self.titleLinesNumber offset:self.titleOffset];
}
...
- (ICETutorialLabelStyle *)subTitleStyle {
    ...
    return [[ICETutorialLabelStyle alloc] initWithFont:self.subTitleFont textColor:self.subTitleColor linesNumber:self.subTitleLinesNumber offset:self.subTitleOffset];
}
