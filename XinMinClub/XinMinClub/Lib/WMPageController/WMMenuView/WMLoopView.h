...
@property (nonatomic, assign) BOOL isloopNetwork;

- (instancetype)initWithFrame:(CGRect)frame images:(NSArray *)images autoPlay:(BOOL)isAuto delay:(NSTimeInterval)timeInterval isLoopNetwork:(BOOL)loop;
